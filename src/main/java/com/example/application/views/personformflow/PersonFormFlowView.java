package com.example.application.views.personformflow;
...
@PageTitle("Person Form (Flow)")
@Menu(icon = "line-awesome/svg/user.svg", order = 0)
@Route(value = "")
@RouteAlias(value = "")
public class PersonFormFlowView extends Composite<VerticalLayout> {

    public PersonFormFlowView() {
